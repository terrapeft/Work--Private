...
namespace UsersDb.DataContext
{
    ...
    public class UsersDataContext : UsersEntities
    {
        ...
        {
            user.FailedLoginAttemptsCnt = null;
        ...
        public bool IsValidIP(string ip)
        {
            ...
            spIsAllowedIpAddress(ip, isValid);
        ...
        public static bool IsAdministrator
        {
            get
            {
                return CurrentSessionUser?.Roles.Where(r => !r.IsDeleted).Any(r => r.Permissions.Any(p => p.Id == (int)UiPermission.AccessAdminUI)) ?? false;
            }
        }
    }
}