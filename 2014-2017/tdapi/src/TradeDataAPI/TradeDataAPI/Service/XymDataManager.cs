...
namespace TradeDataAPI.Service
{
    using System.Data;
    using UsersDb;
    ...
    public class XymDataManager
    {
        ...
        /// <returns></returns>
        public static DataTable FindSeries(string exchangeCode, string contractNumber, SearchParametersJson prms, out int count)
        {
        ...
        /// <param name="prms">The PRMS.</param>
        /// <returns></returns>
        private static DataTable ApplyRulesAndFiltersForSeries(UsersDataContext dataContext, DataTable seriesTable, SearchParametersJson prms)
        {
            var se = new SearchEngine(dataContext, prms);
            var results = se
                ...
                .ApplyRulesAndFilters()
                .ActualizeResults()
                .GetPage(prms.PageNumber, prms.PageSize, Constants.ExchangeCodeColumn, Constants.ContractNumberColumn);

            return results.ResultsDataTable;
        }
