...
namespace UsersDb
{
	...
	public class ServiceConfig
	{
		...
		/// <summary>
		/// Defines search results look and feel (collapsed panels content)
		/// </summary>
		public static string Search_Output_Table { get { return GetString(39); } }

		/// <summary>
		/// Defines search results look and feel (collapsed panels content)
		/// </summary>
		public static string Search_Output_Row { get { return GetString(40); } }
		...
		/// <summary>
		/// The trial user company is formed either from this template or the name provided by user.
		/// 
		/// Placeholder stands for email.
		/// </summary>
		public static string Trial_Company_Name_Template { get { return GetString(70); } }
		...
		/// 
		/// Parameter "ud" stands for "User Data", and cannot be renamed.
		/// 
		/// Placeholder waits for the token.
		/// </summary>
		public static string Trial_User_Verification_Link { get { return GetString(81); } }
		...
		/// <summary>
		/// URL of the customer's site.
		/// </summary>
		public static string TradeData_API_Front_End_URL { get { return GetString(83); } }
