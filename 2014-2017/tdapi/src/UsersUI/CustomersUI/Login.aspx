<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CustomersUI.Login" %>
...
<body>
    <form runat="server">
        <asp:Panel ID="Panel1" runat="server" CssClass="container centered" DefaultButton="btnSubmit">
            <div style="width: 320px" class="panel panel-default centered">
                ...
                <div class="clear" style="margin: 15px;">
                    <asp:Label id="errorLabel" runat="server" Visible="false">
                        <%=string.Format(Resources.CUI_Invalid_Login_Attempt_Label, ServiceConfig.Contact_Information_Email, ServiceConfig.Contact_Information_Phone) %>
                     </asp:Label>
                    <div class="input-group">
                        <label class="input-group-addon" for="<%= txtUserName.ClientID %>">Email</label>
                        <input id="txtUserName" class="form-control" placeholder="Enter email" runat="server" type="email" />
                    </div>
                    <div class="input-group">
