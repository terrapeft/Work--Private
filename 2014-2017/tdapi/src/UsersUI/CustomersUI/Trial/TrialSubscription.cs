        ...
        public void StartTrial()
        {
            ...
            using (var dc = new UsersDataContext())
            {
                ...
                else
                {
                    ...
                    var logoFile = string.Format(@"\\{0}\MSSQLSRV_ATTACHMENTS\emailLogo.png", Environment.MachineName);
                    ...
                    {
                        User = user, VerificationCode = verificationCode, SubscriptionRequest = request
                    };
                    ...
                    var verificationUrl = new Uri(
                        ...
                        string.Format(ServiceConfig.Trial_User_Verification_Link.Replace("~/", string.Empty), verificationCode)).ToString();
