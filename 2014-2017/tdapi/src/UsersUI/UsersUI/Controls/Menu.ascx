<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menu.ascx.cs" Inherits="UsersUI.Controls.Menu" %>
...
<nav class="navbar navbar-default plain-bar min-width-hundred-percent" data-spy="affix" data-offset-top="90">
    <div class="container-fluid">
        <div class="navbar-header hidden-xs hidden-sm" style="margin: 3px 15px 3px 0;">
        ...
        <div class="collapse navbar-collapse" id="admin-menu">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a id="loginInfo1_HyperLink1" class="dropdown-toggle" data-hover="dropdown" data-delay="300" data-close-others="true" href="#"><%= UsersDataContext.CurrentSessionUser.FullName %> <span class="glyphicon glyphicon-chevron-down" style="position: relative; top: 3px;"></span></a>
