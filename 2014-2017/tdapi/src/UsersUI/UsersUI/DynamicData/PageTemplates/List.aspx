<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="UsersUI.List" ValidateRequest="false" %>

<%@ Register TagPrefix="telerik" Namespace="UsersUI" Assembly="UsersUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <div runat="server" id="descriptionDiv" visible="False" class="alert alert-info fade in">
            <a href="#" style="position: relative; top: -3px;" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>
            <span runat="server" id="descriptionContent"></span>
        </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <telerik:RadGridEx runat="server" ID="RadGrid" DataSourceID="GridDataSource" Skin="Sitefinity" AutoGenerateColumns="false" AllowSorting="True" AllowPaging="True" AllowCustomPaging="true" PageSize="50" UseAsDynamic="True" GroupingEnabled="true" GridLines="Both" AllowMultiRowSelection="True" AllowMultiRowEdit="false"
                ...
                <MasterTableView GroupsDefaultExpanded="False" GroupLoadMode="Client" EnableColumnsViewState="false" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" InsertItemPageIndexAction="ShowItemOnCurrentPage"
