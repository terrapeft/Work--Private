<%@ Control Language="C#" CodeBehind="Integer_Edit.ascx.cs" Inherits="UsersUI.Integer_EditField" %>


<asp:TextBox ID="TextBox1" runat="server" Text='<%# FieldValueEditString %>' Columns="10" CssClass="DDTextBox" TextMode="Number"></asp:TextBox>
