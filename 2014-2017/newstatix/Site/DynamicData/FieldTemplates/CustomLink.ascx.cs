...
{
    public partial class CustomLink : System.Web.DynamicData.FieldTemplateUserControl
    {
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            if (isEnabled)
            {
                ...
                Link1.HRef = string.Format(Link1.HRef, table.Name.Replace("StatixApp", string.Empty).ToLower(), filter);
