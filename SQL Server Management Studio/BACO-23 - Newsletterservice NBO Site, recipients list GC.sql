...
declare	@SubEndDate				DATETIME = '2019-09-16'
declare	@TrialEndDate				DATETIME = '2019-09-16'
declare	@IncludeRegistrants		BIT = 0
	...
	(
		...
		WHERE
			...
			AND nuc.IsSelected = 1 -- get the last user's choice and only if newsletter was selected
	)
	SELECT DISTINCT 
		 u.UserId
		,u.UserName
	...
	WHERE 
	SubscriptionTypePriorityOrder = 1 -- get the Subscription with the most priority Subscription Type
	--and u.userid in (1774588, 2651450, 1060136)
