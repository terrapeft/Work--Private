...
BEGIN TRY
    ...
    DECLARE @scID INT;
    DECLARE @sdID INT;
	DECLARE @PublicationName NVARCHAR(MAX) = 'AMM Events';
	DECLARE @PublicationURL NVARCHAR(MAX) = 'events.amm.com';
	DECLARE @ClaimName NVARCHAR(MAX) = 'registrant';
	DECLARE @SubscriptionName NVARCHAR(MAX) = 'AMM Events Registration';
	DECLARE @iiPublicationId INT = 291;
...
StatusId: 1179      
ProductCatalogId: 21645     
OrderCodeId: 20921     
SourceCodeId: 33699     
SubDefinitionId: 64825     
PublicationName: AMM Events
ClaimName: registrant
SubscriptionName: AMM Events Registration
IIPublicationId: 291       
PublicationId: 5032      
RateId: 50070  
