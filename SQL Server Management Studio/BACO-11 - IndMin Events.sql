...
BEGIN TRY
    ...
    DECLARE @scID INT;
    DECLARE @sdID INT;
	DECLARE @PublicationName NVARCHAR(MAX) = 'Industrial Minirals Events';
	DECLARE @PublicationURL NVARCHAR(MAX) = 'events.indmin.com';
	DECLARE @ClaimName NVARCHAR(MAX) = 'registrant';
	DECLARE @SubscriptionName NVARCHAR(MAX) = 'Industrial Minirals Events Registration';
	DECLARE @iiPublicationId INT = 223;
...
StatusId: 1180      
ProductCatalogId: 21647     
OrderCodeId: 20923     
SourceCodeId: 33701     
SubDefinitionId: 64829     
PublicationName: Industrial Minirals Events
ClaimName: registrant
SubscriptionName: Industrial Minirals Events Registration
IIPublicationId: 223       
PublicationId: 5033      
RateId: 50073   
