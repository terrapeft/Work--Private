...
select * 
from EdenCode
where edcCode in ('1560', '1561', '1562', '1563', '1564', '1565', '6732', '6733', '6734', '6735', '6736', '6737', '6738', '6739', '6740', '6741', '6742', '6743',
...
from EdenGroup e join Publications p on e.edgPublicationid = p.pid
join EdenGroupCodes c on e.edgGroupId = c.egcGroupId
join EdenCode ec on c.egcCodeId = ec.edcCodeId
--where edcCode in ('1560', '1561', '1562', '1563', '1564', '1565')
where edgtext = 'Job Function'

select * from publications where pname like 'managing%'
...
BEGIN TRY
		...
		*/
		...
		begin
			insert into [NewCentralUsers].[dbo].[EdenGroup] (
				...
				edgPrefixID,
				edgHorizontalAlign)
			output inserted.edgGroupId into @output(ID)
			values (
				'Job Function',
			...
			print 'Managing IP Job Function edgGroupID: ' + CONVERT(VARCHAR, @id)
		end
		else
	...
	--    Company Types
	-- ========================================================================
		if not exists (select 1 from [NewCentralUsers].[dbo].[EdenGroup] where edgPublicationID = 5027 and edgText = 'Company Type') 
		begin
			insert into [NewCentralUsers].[dbo].[EdenGroup] (
				edgText,
				edgPublicationID,
	...
	--    Interest Area
	-- ========================================================================
		if not exists (select 1 from [NewCentralUsers].[dbo].[EdenGroup] where edgPublicationID = 5027 and edgText = 'Interest Area') 
		begin
			insert into [NewCentralUsers].[dbo].[EdenGroup] (
				edgText,
				edgPublicationID,
